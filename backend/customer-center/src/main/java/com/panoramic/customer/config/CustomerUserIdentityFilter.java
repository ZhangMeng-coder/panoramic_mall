...
/**
 * customer-center 域操作人身份直取过滤器（信任头模式，无 Redis、不鉴权）。
...
public class CustomerUserIdentityFilter extends OncePerRequestFilter {

    /** gateway 透传 userId 的请求头名（与 common LoginUser / gateway AuthGlobalFilter 对齐） */
    private final String userIdHeader;

    public CustomerUserIdentityFilter(@Value("${panoramic.auth.header-name:X-User-Id}") String userIdHeader) {
