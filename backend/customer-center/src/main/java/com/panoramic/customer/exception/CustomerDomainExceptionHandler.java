package com.panoramic.customer.exception;
...
/**
 * 顾客域（内部接口）异常处理器。
 * <p>customer-center 域已下沉为纯域、无页面消费者，统一把异常还原为<b>真实 HTTP 状态码</b>
...
public class CustomerDomainExceptionHandler {
    ...
    public ResponseEntity<RespData<Void>> handleServiceException(ServiceException e) {
        log.warn("顾客域业务异常: code={}, msg={}", e.getCode(), e.getMessage());
